    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-stone-50 px-4 py-12">
      <div className="w-full max-w-[440px]">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground tracking-tight">{t('registerTitle')}</h1>
          <p className="text-muted-foreground mt-2 text-[15px]">{t('registerDescription')}</p>
        </div>
