      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10 lg:py-12 bg-stone-50 relative">
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          <div className="lg:hidden mb-10">
            ...
            <p className="text-muted-foreground mt-1.5 text-[15px] leading-relaxed">{t('logInDescription')}</p>
          </div>

          {/* Desktop heading */}
          <div className="hidden lg:block mb-8">
            <h1 className="text-[1.7rem] font-bold text-foreground tracking-tight">{t('logInTitle')}</h1>
            <p className="text-muted-foreground mt-2 text-[15px] leading-relaxed">{t('logInDescription')}</p>
          </div>
